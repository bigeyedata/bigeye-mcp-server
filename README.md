...
- **`list_table_metrics`** — List compact summaries of all metrics on a table (use get_metric for full details)
- **`get_metric`** — Get full configuration details for a single metric by ID
